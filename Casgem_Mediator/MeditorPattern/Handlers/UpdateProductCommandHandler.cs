...
{
    public class UpdateProductCommandHandler : IRequestHandler<UpdateüProductCommand>
    {
        ...
        public async Task<Unit> Handle(UpdateüProductCommand request, CancellationToken cancellationToken)
        {
